...
(() => {
  ...
  const T = {
    ru: {
      ...
      clip_hero_title_accent: "YouTube видео",
      clip_hero_title_2: "до скачивания",
      clip_hero_subtitle: "Выберите In/Out по таймлайну и скачайте только нужный фрагмент — без потери качества и без загрузки файлов на сторонние сайты.",
      clip_hero_badge_1: "Clip before download",
      clip_hero_badge_2: "Работает локально",
      clip_hero_badge_3: "До 1080p бесплатно",
      clip_hero_b1: "• Экономия времени: не скачиваете лишнее",
      clip_hero_b2: "• Экономия места: только нужный кусок",
      clip_hero_b3: "• Удобно для монтажа, SMM и обучения",
      


      clip_how_title: "Как обрезать YouTube видео до скачивания",
      clip_how_subtitle: "4 простых шага — без онлайн-сервисов и без потери качества.",

      clip_how_1_t: "Вставьте ссылку",
      clip_how_1_p: "Откройте вкладку «Фрагмент» и вставьте ссылку на видео YouTube.",

      clip_how_2_t: "Выберите In/Out",
      clip_how_2_p: "Двигайте маркеры на таймлайне или введите точные таймкоды.",

      clip_how_3_t: "Добавьте фрагмент",
      clip_how_3_p: "Можно собрать несколько клипов из одного видео и скачать пачкой.",

      clip_how_4_t: "Скачайте в нужном качестве",
      clip_how_4_p: "Вы получаете только выбранный кусок — быстро, локально и без “перезаливов”.",

      clip_how_cta_h: "Готовы попробовать?",
      clip_how_cta_p: "Скачайте Avenor и обрежьте первое видео за минуту.",


      clip_use_title: "Кому полезна обрезка YouTube видео до скачивания",
      clip_use_subtitle: "Сценарии, где важны скорость, точность и контроль над качеством.",

      clip_use_1_t: "Монтажёрам",
      clip_use_1_p: "Вырезайте нужные сцены (In/Out) и скачивайте только их — меньше мусора на диске и быстрее импорт в монтажку.",

      clip_use_2_t: "SMM и контент-креаторам",
      clip_use_2_p: "Соберите несколько клипов из одного ролика и скачайте пакетом — удобно для Reels/TikTok/Shorts.",

      clip_use_3_t: "Учёбе и курсам",
      clip_use_3_p: "Сохраните только нужный фрагмент лекции или главы — без перемотки и без лишних гигабайтов.",

      clip_use_4_t: "Подкастам и интервью",
      clip_use_4_p: "Быстро извлекайте нужные куски и при необходимости сохраняйте только аудио.",

      clip_use_wide_t: "Почему это лучше онлайн-сервисов",
      clip_use_wide_p: "Avenor работает локально на вашем компьютере: без перезагрузок на “чужие серверы”, без лишних ограничений и с контролем качества.",

      clip_use_b1: "Локально и приватно",
      clip_use_b2: "Сохраняет максимальное качество",
      clip_use_b3: "Удобно собирать клипы пачкой",

      clip_focus_kicker: "Главная фишка",
      clip_focus_title: "Обрежьте YouTube видео до скачивания — и скачайте только нужный фрагмент",
      clip_focus_subtitle: "Выбирайте In/Out по таймлайну, добавляйте несколько клипов и скачивайте их по очереди или пакетом.",
      
      clip_focus_li_1: "In/Out до секунды — без ручных “угадываний”",
      clip_focus_li_2: "Несколько клипов из одного видео (Clip 01, Clip 02…)",
      clip_focus_li_3: "Скачивание клипов без потери качества",
      clip_focus_li_4: "PRO: пакетная загрузка фрагментов",
      
      clip_focus_btn: "Попробовать бесплатно",
      clip_focus_btn2: "Сравнить тарифы",
      clip_focus_note: "Совет: используйте фрагменты, чтобы быстро делать клипы для Shorts/Reels/TikTok из длинных роликов.",
      

      clip_how_title: "Как обрезать YouTube видео до скачивания",
      clip_how_subtitle: "3 шага — и у вас на компьютере только нужный фрагмент, без лишнего.",

      clip_how_1_t: "Вставьте ссылку на YouTube",
      clip_how_1_p: "Avenor подтянет видео, превью и доступные качества.",

      clip_how_2_t: "Выберите In / Out по таймлайну",
      clip_how_2_p: "Перетаскивайте маркеры или введите время — точность до секунды.",

      clip_how_3_t: "Скачайте фрагмент или пакет клипов",
      clip_how_3_p: "Сохраняйте клипы как Clip 01, Clip 02… и скачивайте все сразу (PRO).",

      clip_how_chip_1: "Без загрузки на сервера",
      clip_how_chip_2: "Контроль качества (до 1080p Free)",
      clip_how_chip_3: "PRO: до 8K + batch",
      ...
      clip_faq_q1: "Можно ли обрезать YouTube видео до скачивания?",
      clip_faq_a1: "Да. Avenor позволяет выбрать начало (In) и конец (Out) по таймлайну и скачать только нужный фрагмент видео, без предварительной загрузки всего файла.",
      
      clip_faq_q2: "В каком качестве сохраняется клип?",
      clip_faq_a2: "Клип сохраняется в оригинальном качестве источника. В Free-плане — до 1080p, в PRO — до 2K, 4K и 8K без сжатия.",
      
      clip_faq_q3: "Законно ли скачивать фрагменты YouTube видео?",
      clip_faq_a3: "Avenor — это инструмент. Использование контента должно соответствовать законодательству и правилам платформы. Обычно допускается работа с собственным, открытым или разрешённым контентом.",
      
      clip_faq_q4: "Чем Avenor лучше онлайн-сервисов?",
      clip_faq_a4: "Онлайн-сайты загружают видео на серверы, ограничивают длительность и качество. Avenor работает локально на вашем компьютере — быстрее, безопаснее и без рекламы.",
      
      clip_faq_q5: "Нужно ли регистрироваться или создавать аккаунт?",
      clip_faq_a5: "Нет. Для использования Free-версии регистрация не требуется. PRO-функции активируются по email после покупки.",
      
      clip_faq_btn: "Скачать Avenor бесплатно",
      
      clip_vs_title: "Почему Avenor лучше онлайн-сервисов",
      clip_vs_subtitle: "Онлайн-загрузчики выглядят удобно, но имеют серьёзные ограничения. Avenor решает эти проблемы.",

      clip_vs_online_t: "Онлайн-сервисы",
      clip_vs_online_1: "Ограничение по длительности и размеру видео",
      clip_vs_online_2: "Потеря качества и перекодирование",
      clip_vs_online_3: "Очереди, капчи и реклама",
      clip_vs_online_4: "Файлы загружаются на сторонние серверы",
      clip_vs_online_5: "Часто не работают с YouTube и TikTok",

      clip_vs_avenor_t: "Avenor Downloader",
      clip_vs_avenor_1: "Обрезка видео до скачивания",
      clip_vs_avenor_2: "Оригинальное качество без сжатия",
      clip_vs_avenor_3: "Без рекламы и ожидания",
      clip_vs_avenor_4: "Работает полностью локально",
      clip_vs_avenor_5: "Стабильно с YouTube, Instagram, TikTok",

      clip_vs_note: "Avenor — это настольное приложение, а не сайт-посредник. Ваши видео не загружаются в интернет и не обрабатываются на чужих серверах.",
      clip_vs_btn: "Скачать Avenor бесплатно",

      clip_use_subtitle: "Avenor создан для тех, кому важно быстро получать нужный фрагмент видео — без лишних минут и повторных загрузок.",

      clip_use_1_t: "Монтажёры и видеоредакторы",
      clip_use_1_p: "Скачивайте только нужные сцены для Premiere Pro, After Effects или DaVinci Resolve. Экономьте время и место на диске.",
      clip_use_1_li1: "Обрезка до скачивания",
      clip_use_1_li2: "Чистое качество без перекодирования",
      clip_use_1_li3: "Готово для монтажа",

      clip_use_2_t: "SMM и контент-креаторы",
      clip_use_2_p: "Быстро нарезайте клипы для TikTok, Reels и Shorts прямо перед загрузкой.",
      clip_use_2_li1: "Выбор In / Out по таймлайну",
      clip_use_2_li2: "Несколько клипов из одного видео",
      clip_use_2_li3: "Batch-скачивание (PRO)",

      clip_use_3_t: "Обучение и курсы",
      clip_use_3_p: "Сохраняйте только нужные главы лекций, туториалов и вебинаров.",
      clip_use_3_li1: "Точные таймкоды",
      clip_use_3_li2: "Удобная навигация по клипам",
      clip_use_3_li3: "Офлайн-доступ",

      clip_use_4_t: "Подкасты и аудио-контент",
      clip_use_4_p: "Извлекайте только нужные фрагменты и сохраняйте их как аудио.",
      clip_use_4_li1: "Только аудио (MP3)",
      clip_use_4_li2: "Без потери качества",
      clip_use_4_li3: "Быстро и локально",

      clip_use_cta_text: "Независимо от задачи — Avenor помогает скачать именно то, что вам нужно.",
      clip_use_cta_btn: "Скачать Avenor бесплатно",
